...
Call log:
  - waiting for getByRole('link', { name: 'Scaling Regenerative' })
    - locator resolved to <a data-no-tracking-url="" href="/en/agriculture/regenerativeag">…</a>
  - attempting click action
    ...
    at goToScalingRegenerative (D:\Automation\pages\basePage.ts:16:66)
    at D:\Automation\tests\specs\globalsitenavigation.spec.ts:20:32
```
...
- main:
  - article:
    - text: Crop Science
    - heading "Produce More. Restore Nature. Scale Regenerative Agriculture." [level=1]
    - article:
      - img "Regenerative Agriculture_Hero Image"
    - list:
      - listitem:
        - link "Overview":
          - /url: /en/agriculture-overview
    ...
    - heading "“Producing more while restoring more”" [level=2]
    - paragraph:
      - text: "Regenerative agriculture forms our vision for the future of farming, based on our Crop Science Vision:"
      - strong: Produce 50% more. Restore Nature. Scale Regenerative Agriculture.
    - paragraph:
      - text: The world is hungry – not only for food, fiber and fuel, but for
      - link "innovative solutions":
        - /url: /en/agriculture/advances-agriculture
      - text: that restore natural resources, like soil and water, and help address climate change.
    - paragraph:
      - text: The world’s farmers need to grow 50% more by 2050 to feed, clothe and fuel the growing world. At Bayer, we believe
      - link "feeding the world":
        - /url: /en/agriculture/food-security
      - text: and
      - link "restoring the planet":
        - /url: /en/agriculture/regenerativeag
      - text: can – and should – go hand in hand.
    - paragraph: Increasing crop production and reversing global warming were once considered incompatible, but we now have solutions to do both. It’s time to make them available to more farms around the world.
    - paragraph: That’s why at Bayer, we’re innovating together with a growing number of farmers and partners to advance regenerative agriculture as the way of the future – a future where farming produces more and restores more at the same time.
    - 'heading "Focus Areas: Our Vision for the Future of Agriculture" [level=3]'
    - link "Scaling Regenerative Agriculture Learn More":
      - /url: /en/agriculture/regenerativeag
      - article:
        - img "Regenerative Agriculture_Hero Image"
      - text: Scaling Regenerative Agriculture Learn More
    - link "Advances in Agriculture Learn More":
      - /url: /en/agriculture/advances-agriculture
      - text: Advances in Agriculture Learn More
      - article:
        - img "Advances in Agriculture"
    - link "Helping to Feed the World Sustainably Learn More":
      - /url: /en/agriculture/food-security
      - article:
        - img "Wheat Crop"
      - text: Helping to Feed the World Sustainably Learn More
- contentinfo:
  - text: "Last Updated:"
