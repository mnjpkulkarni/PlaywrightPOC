...
Call log:
  - waiting for locator('#block-header-section').getByRole('link', { name: 'Overview' })
    - locator resolved to <a href="/en/products" data-drupal-link-system-path="node/146">Overview</a>
  ...
  - list:
    ...
    - listitem:
      ...
      - link "products":
        - /url: ""
        - img "products"
      - paragraph: With our distinctive knowledge of people, animals and plants, we intend to focus in future on the life science businesses.
      - list:
        - listitem:
          - link "Overview":
            - /url: /en/products
